...
@Table(
        ...
        indexes = {
                @Index(name = "idx_compliance_status_org_id", columnList = "org_id"),
                @Index(name = "idx_compliance_status_user_id", columnList = "user_id"),
                @Index(name = "idx_compliance_status_standard_id", columnList = "standard_id")
        }
)
@Getter
@Setter
